...
function main() {
	//document.getElementById("inputCanvas").getContext("2d").drawImage(document.getElementById("coordinateSystem"), 0, 0);
	...
	(function (inputCanvas) {
		...
		*/
		...
		/* public methods
		inputCcanvas.publicMethod = function() {return x;}
		*/
	
	}(window.inputCanvas = window.inputCanvas || {}));
